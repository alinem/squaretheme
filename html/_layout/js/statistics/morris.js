(function() {
  ...
  Morris.Hover = (function() {
    ...
    Hover.prototype.moveTo = function(x, y) {
	  ...
	  if (left == 0)
	  	return this.el.css({left: left-35 + "px", top: parseInt(top)-10 + "px"});
	  if(left>=460)
	  	return this.el.css({left: left+35 + "px", top: parseInt(top)-10 + "px"});
      return this.el.css({
        left: left + "px",
  ...
  Morris.Line = (function(_super) {
    ...
    Line.prototype.defaults = {
      lineWidth: 3,
      pointSize: 5,
      lineColors: ['#71d9e2', '#0b62a4', '#7A92A3', '#4da74d', '#afd8f8', '#edc240', '#cb4b4b', '#9440ed'],
      pointWidths: [2],
      pointStrokeColors: ['#fff'],
      pointFillColors: ['#646464'],
      smooth: false,
      xLabels: 'auto',
      xLabelFormat: null,
      xLabelMargin: 24,
  ...
  Morris.Bar = (function(_super) {
    ...
    Bar.prototype.defaults = {
      barSizeRatio: 0.75,
      barGap: 3,
      barColors: ['#555555', '#0b62a4', '#7a92a3', '#4da74d', '#afd8f8', '#edc240', '#cb4b4b', '#9440ed'],
      xLabelMargin: 50
    };
  ...
  Morris.Donut = (function(_super) {
    ...
    Donut.prototype.defaults = {
      colors: ['#000000', '#0B62A4', '#3980B5', '#679DC6', '#95BBD7', '#B0CCE1', '#095791', '#095085', '#083E67', '#052C48', '#042135'],
